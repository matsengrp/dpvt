...
def make_random_tree(tip_subtrees):
    ...
    is randomly generated by the populate method of an ete4 tree with 'uniform' model.
    The randomly generated tree is made with len(tip_subtrees) leaf nodes, which are then
    replaced with with the nodes of tip_subtrees.
    """
